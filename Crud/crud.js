...
function llenaTabla() {
    ...
    for (var i = 0; i < colores.length; i++) {
        ...
        var input = '<input id="input' + i + '" class="form-control d-none" value="' + colores[i] + '" data-indice="' + i + '">';
        var guardar = '<button class="btn btn-success btnGuard d-none" id="boton' + i + '" data-indice="' + i + '">Guardar</button>';
...
function eventos() {
    ...
    var btnGuardar = document.querySelectorAll(".btnGuard")
